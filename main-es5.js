...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function distRodmanCoreFesm2015RodmanCoreJs(module, __webpack_exports__, __webpack_require__) {
          ...
          */
          function (data) {
            if (data.status == "success" && data.message == "login successfully") {
              localStorage.setItem('authDetails' + _this5.magazineId, JSON.stringify(data.data)); // console.log(localStorage.getItem('authDetails'+this.magazineId));
    ...
    function () {
      ...
      function AdsDisplayComponent(CookieService, RodmanCoreService, deviceService) {
        ...
        this.screenDetect(); // this.Url =  RodmanCoreService.returnUrl();
    ...
    function () {
      ...
      _createClass(SliderComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // console.log('fsfdf')
        ...
        value: function ngOnInit() {
          ...
          */
          function (data) {
            ...
            _this9.viewAdRender = 1; // console.log(this.getAllAd);
          });
        }
        /**
         * @param {?} imageId
    ...
    function () {
      ...
      _createClass(StaticContentService, [{
        ...
        value: function getStaticContent(slug, magazineId, limit, page, contentType) {
          ...
          /** @type {?} */
          var slugs = slug.replace('/', ''); // console.log(slugs)
    ...
    function () {
       ...
       */
      function ContentRelatedComponent(ContentRelatedService) {
    ...
    function () {
       ...
       * @param {?} ContentRelatedService
       */
      function ContentSuggestSlideShowComponent(Router, config, ContentRelatedService) {
    ...
    function () {
       ...
       * @param {?} Router
       */
      function ContentBoxTabsComponent(ContentBoxTabsService, Router) {
        var _this24 = this;
    ...
    function () {
      ...
      _createClass(UserProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function (data) {
            _this28.magazineId = data.magazineId; // console.log(this.magazineId)
          });
    ...
    function () {
       ...
       */
      function ContentCompanyRelatedComponent(ContentCompanyRelatedService) {
    ...
    function () {
        ...
        */
        function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"]) {
            ...
            _this35.lastSlug = data[data.length - 1];
            _this35.routeChange = true;
          }

          if (_this35.routeChange) {
            _this35.issueData = []; // this.sliderData =[];

            _this35.getIssue(_this35.lastSlug);

            _this35.routeChange = false;
          }
        });
      }
      /**
      ...
      _createClass(ContentIssueComponent, [{
        ...
        value: function getIssue(slug) {
          ...
          */
          function (data) {
            ...
            _this37.sliderData = data['issue']; // console.log(this.sliderData)

            _this37.page = 1; // }      

            _this37.nextIssue = data['nextIssue'];
        ...
        value: function getads() {
          ...
          */
          function (data) {
            _this38.getAllAd = data;
            _this38.viewAdRender = 1;
          });
        }
        /**
         * @param {?} slug
        ...
        value: function loadMoreData(slug) {
          this.loading = true; // this.ptintTittle=true;
    ...
    function () {
      ...
      _createClass(ContentRssFeedsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function (data) {
            _this39.magazineId = data.magazineId;
          });
          this.rssDataMethod();
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(
          /**
          ...
          */
          function (data) {
            _this39.getAllAd = data;
            _this39.viewAdRender = 1;
          });
        }
        /**
         * @return {?}
      ...
      _createClass(ContentListsComponent, [{
        ...
        value: function viewData() {
          ...
          if (this.dataFetch == false) {
            ...
            */
            function (data) {
              _this41.dataFetch = true;
              _this41.contentData = data['data'];
              _this41.contentDataView[0] = data['data'];
              _this41.page = data['data'].slug;
              _this41.displayDefault = 1;
    ...
    function () {
      ...
      function ContentsWebinarComponent(ListContentService, RodmanCoreService, Router, ActivatedRoute) {
        ...
        */
        function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationEnd"]) {
            _this43.currentURL = event.url;

            if (_this43.currentURL == '/contents/list_webinars') {
              _this43.currentURL = '';
              _this43.contentType = '2542';
            }
          }
        });
      }
      ...
      _createClass(ContentsWebinarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          */
          function (data) {
            _this44.magazineId = data.magazineId;
          });
          this.getContentData();
          this.getads();
        }
        ...
        value: function getContentData() {
          ...
          */
          function (data) {
            _this45.listContentData = data['data'];

            if (_this45.page == 0) {
              _this45.slugHeading = data['contentTypeName'];
            }

            _this45.page = data['page'] + 1;
        ...
        value: function buyersguideCountry() {
          ...
          */
          function (data) {
            ...
            console.log(_this54.buyersguideCountryData);
          });
        }
        /**
         * @param {?} current
    ...
    /*#__PURE__*/
    function () {
      function DirectorySearchBoxComponent() {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContentContentViewContentViewComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUserComponentUserMailVerifyUserMailVerifyComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<CoreLib-users-verify-email magazineId={{magazineId}} email={{email}} passKey={{token}} ></CoreLib-users-verify-email>\n";
    /***/
  },
    ...
    function () {
      ...
      _createClass(ContentInfographicsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this58.magazineId = data.magazineId;
          });
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
            _this58.getAllAd = data;
            _this58.viewAdRender = 1;
          });
        }
      }]);
    ...
    function () {
      function ContentIssueComponent(RodmanCoreService, ActivatedRoute, Router, ContentIssueService) {
        ...
        Router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_4__["NavigationStart"]) {
            var data = event.url.split('/');
            _this59.lastSlug = data[data.length - 1];
            _this59.routeChange = true;
          }

          if (_this59.routeChange) {
            _this59.issueData = []; // this.sliderData =[];

            _this59.getIssue(_this59.lastSlug);

            _this59.routeChange = false;
          }
        });
      }
      ...
      _createClass(ContentIssueComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this60.magazineId = data.magazineId;
          });
          this.getIssue(this.slug);
          this.getads();
        ...
        value: function getIssue(slug) {
          ...
          this.ContentIssueService.getIssue(this.magazineId, slug).subscribe(function (data) {
            var collectData = data['data']; // if(this.page==0)  {

            _this61.sliderData = data['issue']; // console.log(this.sliderData)

            _this61.page = 1; // }      

            _this61.nextIssue = data['nextIssue'];
            var _iteratorNormalCompletion8 = true;
            var _didIteratorError8 = false;
            var _iteratorError8 = undefined;

            try {
              for (var _iterator8 = collectData[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                var _data2 = _step8.value;

                _this61.issueData.push(_data2);
              }
            } catch (err) {
    ...
    function () {
      ...
      _createClass(ContentRssFeedsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this63.magazineId = data.magazineId;
          });
          this.rssDataMethod();
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
            _this63.getAllAd = data;
            _this63.viewAdRender = 1;
          });
        }
      }, {
        key: "rssDataMethod",
  ...
  function rodmanCoreSrcLibContentsContentSearchContentSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ContentSearchComponent(calendar, RodmanCoreService, Router, ContentSearchService, ActivatedRoute) {
        ...
        Router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
            _this65.routeUrl = event.url;
            _this65.contentList = [];

            _this65.ActivatedRoute.params.subscribe(function (params) {
              _this65.page = 0;
              _this65.anySlug = params['any'];
              _this65.searchSlug = params['slug'];
            });

            _this65.getSearchData();
          }
        });
        this.ActivatedRoute.data.subscribe(function (data) {
      ...
      _createClass(ContentSearchComponent, [{
        ...
        value: function getRefineData() {
          ...
          this.ContentSearchService.refineContentList(this.magazineId).subscribe(function (data) {
            _this66.refineContentList = data['country'];
          });
        }
      }, {
        key: "searchSelectFilter",
        ...
        value: function getSearchData() {
          ...
          if (this.loadMoreCheck) {
            this.ContentSearchService.SearchCompany(this.searchSlug, this.page, this.limit, this.magazineId, this.dateFrom, this.dateTo, this.selectedProduct).subscribe(function (data) {
              _this67.companyDataList = data['bgTopCompanies'];
              _this67.comapnyCategory = data['bgCategories'];
              _this67.micrositeCompany = _this67.companyDataList.filter(function (map) {
                return map.has_featured_mircosite_listing == 1;
              });
              _this67.featuredComapny = _this67.companyDataList.filter(function (map) {
                return map.has_featured_mircosite_listing == 0;
              });
            });
            this.loading2 = false;
          ...
          this.ContentSearchService.SearchContent(this.searchSlug, this.page, this.limit, this.magazineId, this.dateFrom, this.dateTo, this.selectedProduct).subscribe(function (data) {
            _this67.putContentList = data['data'];
            var _iteratorNormalCompletion9 = true;
            var _didIteratorError9 = false;
            var _iteratorError9 = undefined;

            try {
              for (var _iterator9 = _this67.putContentList[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                var content = _step9.value;

                _this67.contentList.push(content);
              }
            } catch (err) {
            ...
            _this67.page = data['page'] + 1;
          }); // setTimeout(function(){
          //   this.loading1 = false;
          // },6000);

          setTimeout(function () {
            _this67.loading1 = false;
          }, 10000);
        }
      }, {
        key: "spinnerHide",
        ...
        value: function getPageAds() {
          ...
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
            _this68.getAllAd = data;
            _this68.viewAdRender = 1;
          });
        } // Date Option
    ...
    function () {
      function ContentsWebinarComponent(ListContentService, RodmanCoreService, Router, ActivatedRoute) {
        ...
        Router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
            _this69.currentURL = event.url;

            if (_this69.currentURL == '/contents/list_webinars') {
              _this69.currentURL = '';
              _this69.contentType = '2542';
            }
          }
        });
      }
      ...
      _createClass(ContentsWebinarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this70.magazineId = data.magazineId;
          });
          this.getContentData();
          this.getads();
        }
        ...
        value: function getContentData() {
          ...
          this.ListContentService.getContent(this.currentURL, this.magazineId, this.limit, this.page, this.contentType).subscribe(function (data) {
            _this71.listContentData = data['data'];

            if (_this71.page == 0) {
              _this71.slugHeading = data['contentTypeName'];
            }

            _this71.page = data['page'] + 1;
        ...
        value: function getads() {
          ...
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
            _this72.getAllAd = data;
            _this72.viewAdRender = 1;
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(StaticContentComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this74.magazineId = data.magazineId;
          });
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
        ...
        value: function getStatic() {
          ...
          this.StaticContentService.getStaticContent(this.routeUrl, this.magazineId, this.limit, this.page, this.contentType).subscribe(function (data) {
            _this75.staticContentData = data['data'];
    ...
    function () {
      ...
      _createClass(DirectoryHomePageComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this77.magazineId = data.magazineId;
          });
          this.getPageAd();
          this.buyersguideCategory();
          this.buyerGuideCompany();
        ...
        value: function getPageAd() {
          ...
          this.RodmanCoreService.getAllAdst(this.magazineId).subscribe(function (data) {
            _this78.getAllAd = data;
            _this78.viewAdRender = 1;
          });
        }
      }, {
        key: "buyerGuideCompany",
        value: function buyerGuideCompany() {
          ...
          this.DirectoryHomePageService.buyerGuideCompany(this.magazineId, this.currentURL).subscribe(function (data) {
            _this79.data = data['data'];
            var _iteratorNormalCompletion10 = true;
            var _didIteratorError10 = false;
            var _iteratorError10 = undefined;

            try {
              for (var _iterator10 = _this79.data[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                var compnayCheck = _step10.value;

                if (compnayCheck.has_microsite_listing == 1 && compnayCheck.has_priority_listing == 1 && compnayCheck.has_featured_mircosite_listing == 1) {
                  _this79.featuredmicrositeCompanies.push(compnayCheck);
                } else if (compnayCheck.has_microsite_listing == 1 && compnayCheck.has_priority_listing == 1 && compnayCheck.has_featured_mircosite_listing == 0) {
                  _this79.micrositeCompanies.push(compnayCheck);
                } else if (compnayCheck.has_microsite_listing == 0 && compnayCheck.has_priority_listing == 1 && compnayCheck.has_featured_mircosite_listing == 0) {
                  _this79.featuredBgCompanies.push(compnayCheck); // let checkCompanyTitle = compnayCheck.content_type_id;
                  // if(checkCompanyTitle != this.titleCheck ){}

                }

                if (compnayCheck.title.charAt(0).toUpperCase() != _this79.current_letter) {
                  _this79.current_letter = compnayCheck.title.charAt(0).toUpperCase();

                  _this79.alphabet.push(compnayCheck.title.charAt(0).toUpperCase());
                }
              }
            } catch (err) {
        ...
        value: function buyersguideCategory() {
          ...
          this.DirectoryHomePageService.buyersguideCategory(this.magazineId, this.currentURL).subscribe(function (data) {
            _this80.buyersGuideCategoryData = data['data'];
          });
        }
      }, {
        key: "buyersguideCountry",
        value: function buyersguideCountry() {
          ...
          this.DirectoryHomePageService.buyersguideCountry(this.magazineId, this.currentURL).subscribe(function (data) {
            _this81.buyersguideCountryData = data['country'];
            console.log(_this81.buyersguideCountryData);
          });
        }
      }, {
        key: "matchCharacter",
    ...
    function () {
      ...
      _createClass(UserProfileComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.ActivatedRoute.data.subscribe(function (data) {
            _this83.magazineId = data.magazineId; // console.log(this.magazineId)
          });
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _user_component_user_mail_verify_user_mail_verify_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./user/component/user-mail-verify/user-mail-verify.component */
    "./src/app/user/component/user-mail-verify/user-mail-verify.component.ts");
    /* harmony import */


    var _content_content_view_content_view_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./content/content-view/content-view.component */
    "./src/app/content/content-view/content-view.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_search_content_search_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-search/content-search.component */
    "../rodman-core/src/lib/contents/content-search/content-search.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_sites_components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/sites/components/not-found/not-found.component */
    "../rodman-core/src/lib/sites/components/not-found/not-found.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_users_Components_user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/users/Components/user-profile/user-profile.component */
    "../rodman-core/src/lib/users/Components/user-profile/user-profile.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_static_content_static_content_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/static-content/static-content.component */
    "../rodman-core/src/lib/contents/static-content/static-content.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_glossary_content_glossary_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-glossary/content-glossary.component */
    "../rodman-core/src/lib/contents/content-glossary/content-glossary.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_issue_content_issue_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-issue/content-issue.component */
    "../rodman-core/src/lib/contents/content-issue/content-issue.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_rss_feeds_content_rss_feeds_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-rss-feeds/content-rss-feeds.component */
    "../rodman-core/src/lib/contents/content-rss-feeds/content-rss-feeds.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_directory_section_directory_home_page_directory_home_page_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/directory-section/directory-home-page/directory-home-page.component */
    "../rodman-core/src/lib/directory-section/directory-home-page/directory-home-page.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_infographics_content_infographics_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-infographics/content-infographics.component */
    "../rodman-core/src/lib/contents/content-infographics/content-infographics.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_contents_webinar_contents_webinar_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/contents-webinar/contents-webinar.component */
    "../rodman-core/src/lib/contents/contents-webinar/contents-webinar.component.ts"); // import { ViewContentComponent } from './view-content/view-content.component';
    // Rodman Core Import
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | pen-home-pen-home-module */
        "pen-home-pen-home-module").then(__webpack_require__.bind(null,
        /*! ./pen-home/pen-home.module */
        "./src/app/pen-home/pen-home.module.ts")).then(function (m) {
          return m.PENHomeModule;
        });
      }
    }, // Search Content 
    {
      path: 'contents/list_webinars',
      component: _rodman_core_src_lib_contents_contents_webinar_contents_webinar_component__WEBPACK_IMPORTED_MODULE_15__["ContentsWebinarComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
      path: 'contents/list_infographics',
      component: _rodman_core_src_lib_contents_content_infographics_content_infographics_component__WEBPACK_IMPORTED_MODULE_14__["ContentInfographicsComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
      ...
      path: 'contents/list_ebook',
      component: _rodman_core_src_lib_sites_components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_7__["NotFoundComponent"]
    }, {
      path: 'contents/searchcontent/:any/:slug',
      component: _rodman_core_src_lib_contents_content_search_content_search_component__WEBPACK_IMPORTED_MODULE_6__["ContentSearchComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
    ...
    }, //View Page Content  
    {
      ...
      component: _content_content_view_content_view_component__WEBPACK_IMPORTED_MODULE_5__["ContentViewComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
    ...
    }, //Taxonomy
    {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | taxonomy-taxonomy-module */
        "taxonomy-taxonomy-module").then(__webpack_require__.bind(null,
        /*! ./taxonomy/taxonomy.module */
        "./src/app/taxonomy/taxonomy.module.ts")).then(function (m) {
          return m.TaxonomyModule;
        });
      }
    }, {
      path: 'news/:any',
      ...
      path: 'equipment-and-services/:any',
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | taxonomy-taxonomy-module */
        "taxonomy-taxonomy-module").then(__webpack_require__.bind(null,
    ...
    {
      path: 'glossary',
      component: _rodman_core_src_lib_contents_content_glossary_content_glossary_component__WEBPACK_IMPORTED_MODULE_10__["ContentGlossaryComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
      ...
      loadChildren: function loadChildren() {
        ...
        "content-content-module").then(__webpack_require__.bind(null,
      ...
      path: 'profile',
      component: _rodman_core_src_lib_users_Components_user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_8__["UserProfileComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
      path: 'user/verifyUser/:token/:email',
      component: _user_component_user_mail_verify_user_mail_verify_component__WEBPACK_IMPORTED_MODULE_4__["UserMailVerifyComponent"]
    ...
    {
      path: 'buyersguide',
      component: _rodman_core_src_lib_directory_section_directory_home_page_directory_home_page_component__WEBPACK_IMPORTED_MODULE_13__["DirectoryHomePageComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
      path: 'buyersguide/all_companies',
      component: _rodman_core_src_lib_directory_section_directory_home_page_directory_home_page_component__WEBPACK_IMPORTED_MODULE_13__["DirectoryHomePageComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    ...
    {
      path: 'subscribe-now',
      component: _rodman_core_src_lib_contents_static_content_static_content_component__WEBPACK_IMPORTED_MODULE_9__["StaticContentComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
    ...
    {
      path: 'rssfeeds',
      component: _rodman_core_src_lib_contents_content_rss_feeds_content_rss_feeds_component__WEBPACK_IMPORTED_MODULE_12__["ContentRssFeedsComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    ...
    {
      path: 'issues/:slug',
      component: _rodman_core_src_lib_contents_content_issue_content_issue_component__WEBPACK_IMPORTED_MODULE_11__["ContentIssueComponent"],
      data: {
        magazineId: _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId
      }
    }, {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(spinnerService, Router, ActivatedRoute) {
        var _this84 = this;
      ...
      _createClass(AppComponent, [{
        ...
        value: function spinner() {
          ...
          setTimeout(function () {
            return _this86.spinnerService.hide();
          }, 3000);
        }
      }]);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _rodman_core_src_lib_contents_contents_webinar_contents_webinar_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/contents-webinar/contents-webinar.component */
    "../rodman-core/src/lib/contents/contents-webinar/contents-webinar.component.ts");
    /* harmony import */


    var _user_component_user_mail_verify_user_mail_verify_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./user/component/user-mail-verify/user-mail-verify.component */
    "./src/app/user/component/user-mail-verify/user-mail-verify.component.ts");
    /* harmony import */


    var _content_content_view_content_view_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./content/content-view/content-view.component */
    "./src/app/content/content-view/content-view.component.ts");
    /* harmony import */


    var _rodman_core_src_lib_contents_content_infographics_content_infographics_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ../../../rodman-core/src/lib/contents/content-infographics/content-infographics.component */
    "../rodman-core/src/lib/contents/content-infographics/content-infographics.component.ts"); // Rodman Core Import
  ...
  /***/
  function srcAppContentContentViewContentViewComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContentContentViewContentViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ContentViewComponent(router, activatedRoute) {
        var _this87 = this;
        ...
        router.events.subscribe(function (event) {
          if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
            _this87.contentPageUrl = event.url;
          }
        });
      }
    ...
    ContentViewComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'pen-content-view',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./content-view.component.html */
      "../../node_modules/raw-loader/dist/cjs.js!./src/app/content/content-view/content-view.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./content-view.component.css */
      "./src/app/content/content-view/content-view.component.css")).default]
  ...
  /***/
  function srcAppUserComponentUserMailVerifyUserMailVerifyComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUserComponentUserMailVerifyUserMailVerifyComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UserMailVerifyComponent", function () {
      return UserMailVerifyComponent;
    });
    /* harmony import */
    ...
    var UserMailVerifyComponent =
    /*#__PURE__*/
    function () {
      function UserMailVerifyComponent(ActivatedRoute) {
        var _this88 = this;

        _classCallCheck(this, UserMailVerifyComponent);

        this.ActivatedRoute = ActivatedRoute;
        this.ActivatedRoute.params.subscribe(function (params) {
          _this88.token = params['token'];
          _this88.email = params['email'];
        });
        this.magazineId = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].magazineId;
      }

      _createClass(UserMailVerifyComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    UserMailVerifyComponent.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]
      }];
    };

    UserMailVerifyComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'pen-user-mail-verify',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./user-mail-verify.component.html */
      "../../node_modules/raw-loader/dist/cjs.js!./src/app/user/component/user-mail-verify/user-mail-verify.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./user-mail-verify.component.css */
      "./src/app/user/component/user-mail-verify/user-mail-verify.component.css")).default]
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/bezoar/RodmanAngled/projects/PEN/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
